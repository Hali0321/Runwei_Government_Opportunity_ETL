-- ===================================
-- CREATE CLEANGRANTSLAYER2 TABLE
...
CREATE NONCLUSTERED INDEX IX_CleanGrants_Deadline ON CleanGrantsLayer2 (Deadline DESC) WHERE Deadline IS NOT NULL;
CREATE NONCLUSTERED INDEX IX_CleanGrants_AwardValue ON CleanGrantsLayer2 (AwardValue DESC) WHERE AwardValue IS NOT NULL;
CREATE NONCLUSTERED INDEX IX_CleanGrants_AgencyName ON CleanGrantsLayer2 (AgencyName) WHERE AgencyName IS NOT NULL;
CREATE NONCLUSTERED INDEX IX_CleanGrants_GlobalOpportunity ON CleanGrantsLayer2 (GlobalOpportunity, Deadline DESC);
...
PRINT '🔍 Performance indexes created for key queries';
