                        ...
                        for opportunity in opportunities:
                            try:
                                ...
                                entity = {
                                    ...
                                    "AssistanceListings": clean_text(opportunity.get("cfda", "")),  # Same as CFDANumbers
                                    ...
                                    "ExpectedNumberofAwards": clean_text(opportunity.get("expectedNumOfAwards", "")),  # Same as ExpectedAwards
