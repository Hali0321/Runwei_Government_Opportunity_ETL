...
module_path = '/Users/dinghali/Desktop/Runwei/grants_gov_api_azure/archive/old_versions/layers/layer1_raw_data_collection/scripts/collect_grants_from_website.py'

try:
    # Load the module dynamically
    spec = importlib.util.spec_from_file_location("collect_grants_from_website", module_path)
    collect_grants_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(collect_grants_module)
    AutomatedGrantsFetcher = collect_grants_module.AutomatedGrantsFetcher
